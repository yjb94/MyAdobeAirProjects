...
{	
	...
	public class Tutorial5 extends BasePage
	{
		...
		[Embed(source = "assets/page/game/tutorial/game5-1.png")]
		...
		private function onClick(e:MouseEvent):void
		{
			...
			else if(_tutorial_index == 4)
			{
				...
				_animal_sound.load(new URLRequest("sound/"+"frog.mp3"));
			...
			else if(_tutorial_index == 6)
			{
				...
				_animal_sound.addEventListener(IOErrorEvent.IO_ERROR, isAnimalSoundError);
				_animal_sound.addEventListener(Event.COMPLETE, onAnimalSoundLoaded);
				_animal_sound.load(new URLRequest("sound/"+"chicken.mp3"));
