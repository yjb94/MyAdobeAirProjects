package Page.Reserve.Popup
{
	...
	public class DatePopup extends BasePage
	{
		...
		{
			super();
			(Elever.Main.header.getChildByName("NavigationBar") as NavigationBar).Middle = Text.newText("예약날짜", TITLE_FONT_SIZE, 0x585858);
			...
			if(params.rsvMainData.date_text)
			{
				...
				addChild(BitmapControl.newBitmap(BitmapControl.CALENDER_TOP_LINE, 0, 100*Config.ratio));
				...
				addChild(BitmapControl.newBitmap(BitmapControl.CALNEDER_BOTTOM_LINE, 515*Config.ratio, 1299*Config.ratio));
			}
		}
