package Scroll
{
	...
	{
		private static const HEIGHT_MARGIN:Number = 10*Config.ratio;
		private static const WIDTH_MARGIN:Number = 8*Config.ratio;	//pixel
		private static const THICKNESS:Number = 8*Config.ratio;		//pixel
		private static const ROUNDNESS:Number = 10*Config.ratio;
		...
		public var _scrollbar:Sprite = new Sprite;	//main scrollbar
