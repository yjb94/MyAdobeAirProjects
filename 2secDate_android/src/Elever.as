package
{
	...
	{		
		...
		public static var _car_data:Array = new Array;
		public static var _car_save_data:Vector.<Object> = new Vector.<Object>(2, true);
		
		public static var _user_info:Object = null;
		public static var _request_list:Array = null;
		...
		private function loadCarData():Boolean
		{
			var data:Object = Elever.loadEnviroment("car_info", data);
			if(data == null)
			{
...
//			sprite.graphics.endFill();
		...
		{	
			...
			(_footer.getChildByName("TabBar") as TabBar).addBar(BitmapControl.TAB1_UP, BitmapControl.TAB1_DOWN, "ListPage", {y:0});
			(_footer.getChildByName("TabBar") as TabBar).addBar(BitmapControl.TAB2_UP, BitmapControl.TAB2_DOWN, "ComparePage", {y:0});
			(_footer.getChildByName("TabBar") as TabBar).addBar(BitmapControl.TAB3_UP, BitmapControl.TAB3_DOWN, "RequestListPage", {y:0});
			(_footer.getChildByName("TabBar") as TabBar).addBar(BitmapControl.TAB4_UP, BitmapControl.TAB4_DOWN, "LoginPage", {y:0});
			...
			_user_info = loadEnviroment("user_info", _user_info);
			if(loadCarData())
				changePage(Config.firstPage);
		}
		...
		private function onKeyDown(e:KeyboardEvent):void
		{
			...
			{
				if(_cur_page_name == "DetailPage" && (((_cur_page as Detail).isZoomed)))
				{
					if((_cur_page as Detail).isZoomed)
						(_cur_page as Detail).zoomOut();
					e.preventDefault();
