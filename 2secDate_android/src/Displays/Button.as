package Displays
{
	...
	{	
		...
		public function Button(normal:Object, down:Object, callback:Function=null, x_pos:Number=0, y_pos:Number=0, isVectorPos:Boolean=false, isTabType:Boolean=false, alpha:Number=1, name:String=""):void
		{
			super();
