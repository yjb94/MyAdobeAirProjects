package Displays
{
	...
	public class WebImage extends Sprite
	{
		...
		private var _loaded_content:Bitmap;
		public function get Content():Bitmap { return _loaded_content }
...
//			}
			...
			loader.mask = _mask;
//			loader.alpha = 0;
//			TweenLite.to(loader, TWEEN_DURATION, { alpha:1 });
			
			_loaded_content = loader.content as Bitmap;
