package Displays
{
	...
	{	
		...
		public function RadioButton(isHeightType:Boolean=true, margin:Number=20, callback:Function=null, x_pos:Number=0, y_pos:Number=0):void
		{
			super();
