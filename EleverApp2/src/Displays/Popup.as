package Displays
{
	...
	public class Popup extends Sprite
	{
		...
		public function Popup(type:String, title_text:String, main_text:String, callback:Function):void
		{
			super();
			...
			_bg.addChild(Text.newText(title_text, 25, 0xffffff, 0, bmp.y + TITLE_MARGIN, "center", "NanumGothicBold", Elever.Main.FullWidth));
			var txt:TextField = Text.newText(main_text, 25, 0x828282, 0, bmp.y + bmp.height/2 - MAIN_MINUS_MARGIN, "center", "NanumGothicBold", Elever.Main.FullWidth);
			_bg.addChild(txt);
