package Header
{
	...
	public class SlideBar extends Header
	{
		...
		private function get itemWidth():Number { return Calender.Main.PageWidth/_indexNum; }
		...
		public function set disable(value:Boolean):void
		{
			if(value)
			{
				Calender.Main.dictionary["SlideBar"] = this;
				_saved_y = y;
			...
			{
				Calender.Main.header.addChild(Calender.Main.dictionary["SlideBar"]);
				Calender.Main.deleteItemInDict("SlideBar");
				TweenLite.to(this, DISABLE_TWEEN_DURATION, { y:_saved_y, alpha:_alpha, onComplete:Abled });
			}
		}
		private function Disabled():void
		{
			Calender.Main.header.removeChild(Calender.Main.header.getChildByName("SlideBar"));
		}
