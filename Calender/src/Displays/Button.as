package Displays
{
	...
	{	
		...
		public function Button(normal:Class, down:Class, callback:Function=null, x_pos:Number=0, y_pos:Number=0, isVectorPos:Boolean=false, alpha:Number=1):void
		{
			super();
		...
		private function TabImage(tabType:String="IN"):void
		{
			if(tabType == "IN")
			{
