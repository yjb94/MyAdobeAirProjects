package Scroll
{
	...
	public class ScrollBar extends Sprite
	{
		...
		{
			_width  = (width > Calender.Main.PageWidth) ? Calender.Main.PageWidth : width;		//set the scroll width
			_height = (height > Calender.Main.PageHeight) ? Calender.Main.PageHeight : height;	//set the scroll height
			onResize();
		}
		...
		{			
			this.visible = Calender.Main.isChangingPage ? false : true;	//가독성을 위한 !연산자 안붙히고 논리연산자씀.
