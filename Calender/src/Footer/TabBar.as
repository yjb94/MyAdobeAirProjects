package Footer
{
	...
	public class TabBar extends Footer
	{
		...
		private function get barWidth():Number { return Calender.Main.PageWidth/_bars.numChildren; }
		...
		public function TabBar(file_name:Class, alpha:Number=1):void
		{
			...
			this.y = Calender.Main.FullHeight - this.height;
			this.alpha = alpha;
			this.name = "TabBar";
		...
		public function set barIndex(index:int):void
		{
			if(_tabbed_index == index)
			{
				...
				Calender.Main.changePage(_bars_page_name[_tabbed_index], PageEffect.RIGHT, _bars_page_param[_tabbed_index]);
...
//			_bars_page_param[_tabbed_index].y = Scroller.Y;
			...
			Calender.Main.changePage(_bars_page_name[_tabbed_index], dir, _bars_page_param[_tabbed_index]);
		}
