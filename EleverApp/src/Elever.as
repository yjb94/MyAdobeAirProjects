package
{
	...
	public class Elever extends Sprite
	{
		...
		private var _sideLayer:Sprite;
		public function get sideLayer():Sprite { return _sideLayer; }
		
		private var _sideMenu:SideMenu;
		public function get sideMenu():SideMenu { return _sideMenu; }
...
////////to here////////////////////////////////////////////////////////////////
		...
		private function Render():void
		{
			...
			_footer.addChildAt(new TabBar(BitmapControl.TOP_BG, 0), 0);
			(_footer.getChildByName("TabBar") as TabBar).addBar(BitmapControl.TAB1_UP, BitmapControl.TAB1_DOWN, "TempPage", {y:0});
			(_footer.getChildByName("TabBar") as TabBar).addBar(BitmapControl.TAB2_UP, BitmapControl.TAB2_DOWN, "TempPage", {y:0});
			(_footer.getChildByName("TabBar") as TabBar).addBar(BitmapControl.TAB3_UP, BitmapControl.TAB3_DOWN, "TempPage", {y:0});
			
			
			_sideMenu = new SideMenu(BitmapControl.newBitmap(BitmapControl.SIDE_MENU_BG));
			_sideLayer.addChild(_sideMenu);
		...
		public function changePage(name:String, type:String=PageEffect.LEFT, params:Object=null, duration:Number=0.5):void
		{
			...
			if(_footer) _footer.changePage(_cur_page_name, params);
