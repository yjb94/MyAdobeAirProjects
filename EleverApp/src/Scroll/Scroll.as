package Scroll
{
	...
	public class Scroll extends Sprite
	{
		...
		public function Scroll(isFitMode:Boolean=true, width:Number=-1, height:Number=-1, scrollDir:int=-1, beginY:Number=0)
		{
			...
			height = (height < 0) ? Elever.Main.PageHeight : height;	//set the scroll height
			if(isFitMode) height = Elever.Main.PageHeight-Elever.Main.TopMargin-Elever.Main.HeaderHeight-Elever.Main.footer.height;
		...
		{
			height = Elever.Main.PageHeight-Elever.Main.TopMargin-Elever.Main.HeaderHeight-Elever.Main.footer.height;
