package Displays
{
	...
	public class Popup extends Sprite
	{
		...
		public function Popup(type:String, params:Object = null):void
		{
			...
			if(Elever.Main.topLayer.getChildByName("popup") != null)	//팝업 있을때는 실행 하지 말라고.
				return;
			...
			_bg.addChild(Text.newText(title_text, 25, 0x585858, bmp.x, bmp.y + TITLE_MARGIN, "center", "NanumBarunGothic", bmp.width));
