package
{
	...
	public class Framework extends Sprite
	{
		...
		private static var _main:Framework;
		public static function get Main():Framework{ return _main; }
...
////////to here////////////////////////////////////////////////////////////////
		...
		private function Render():void
		{
			...
			changePage("TempPage", PageEffect.RIGHT);
		...
		public function changePage(name:String, type:String=PageEffect.LEFT, params:Object=null, duration:Number=0.5):void
		{
			...
			{
				_cur_page.dispose();
				if(Framework.Main.dictionary["NavigationBar"])	Framework.Main.dictionary["NavigationBar"].disable = false;
				if(Framework.Main.dictionary["SlideBar"])		Framework.Main.dictionary["SlideBar"].disable = false;
