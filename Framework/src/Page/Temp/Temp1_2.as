package Page.Temp
{
	...
	public class Temp1_2 extends BasePage
	{
		private var _displays:Scroll;
		
		private var _button:Button;
		
		public function Temp1_2(params:Object=null)
		{
			super();
			...
			_displays.addObject(Text.newText("1-2", 33, 0x000000, 0, 100, "left", "NanumGothicBold"));
		...
		{
			Framework.Main.changePage("Temp2Page", PageEffect.LEFT, {x:0.6});
		}
