package Header
{
	...
	public class SlideBar extends Header
	{
		...
		private function get itemWidth():Number { return Framework.Main.PageWidth/_indexNum; }
		...
		public function set disable(value:Boolean):void
		{
			if(value)
			{
				Framework.Main.dictionary["SlideBar"] = this;
				_saved_y = y;
			...
			{
				Framework.Main.header.addChild(Framework.Main.dictionary["SlideBar"]);
				Framework.Main.deleteItemInDict("SlideBar");
				TweenLite.to(this, DISABLE_TWEEN_DURATION, { y:_saved_y, alpha:_alpha, onComplete:Abled });
			}
		}
		private function Disabled():void
		{
			Framework.Main.header.removeChild(Framework.Main.header.getChildByName("SlideBar"));
		}
