package Page.Reserve
{
	...
	{		
		...
		public function Main2(params:Object=null)
		{
			...
			//예약 사람			
			var txt:TextField = Text.newText("예약자명", TEXT_FONT_SIZE, 0x2c2c2c,  35, TEXT_Y_MARGIN, "left", "NanumBarunGothic", 0, 0);
			_displays.addObject(txt);
			
			var obj:Object = Text.newInputTextbox(BitmapControl.RESERVE_TEXTBOX, INPUT_TEXT_FONT_SIZE, "", 0x252525, 192, txt.y + txt.height/2 - TEXTBOX_HEIGHT/2, "left", "NanumBarunGothic");
			...
			var bmp:Bitmap = BitmapControl.newBitmap(BitmapControl.RESERVE_SEPERATE_LINE, 0, obj.txt.y + obj.txt.height + TEXT_Y_MARGIN);
			...
			var phone_obj:Object = Text.newInputTextbox(BitmapControl.RESERVE_TEXTBOX, INPUT_TEXT_FONT_SIZE, str, 0x252525, 192, txt.y + txt.height/2 - TEXTBOX_HEIGHT/2, "left", "NanumBarunGothic");
			...
			bmp = BitmapControl.newBitmap(BitmapControl.RESERVE_SEPERATE_LINE, 0, phone_obj.txt.y + phone_obj.txt.height + TEXT_Y_MARGIN);
			_displays.addObject(bmp);
			...
			obj = Text.newInputTextbox(BitmapControl.RESERVE_TEXTBOX, INPUT_TEXT_FONT_SIZE, "", 0x252525, 192, txt.y + txt.height/2 - TEXTBOX_HEIGHT/2, "left", "NanumBarunGothic");
			...
			//다음 버튼
			_btn_next = new Button(BitmapControl.RESERVE_COMPLETE_BUTTON, BitmapControl.RESERVE_COMPLETE_BUTTON, onButtonNext, 0, _btn_term.y + _btn_term.height + TEXT_Y_MARGIN);
