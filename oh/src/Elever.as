package
{
	...
	{		
		...
		private static var _schedule_index:uint = 0;;
		public static function get ScheduleIndex():uint { return _schedule_index; }
		public static function set ScheduleIndex(value:uint):void { _schedule_index = value; }
		...
		public function initialize(e:Event):void
		{
			...
			ScheduleIndex = uint(loadEnviroment("ScheduleIndex", ScheduleIndex));
...
//			sprite.graphics.endFill();
		...
		private function onActivate(e:Event):void
		{
			...
			if(IsIPhone)
			{
				SilentSwitch.apply();	//iPhoneMute Control
			}
		...
		private function onDeactivate(e:Event):void
		{
			...
			for(var i:int = 0; i < ScheduleIndex; i++)
			{
				saveEnviroment("Schedule/"+i, Page.Home.Home.getIndexObjData(i));
			}
		...
		private function onKeyDown(e:KeyboardEvent):void
		{
			...
			{
				if((_header.getChildByName("NavigationBar") as NavigationBar).hasPrev)
				{
