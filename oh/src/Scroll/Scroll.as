package Scroll
{
	...
	public class Scroll extends Sprite
	{
		...
		public function Scroll(isFitMode:Boolean=true, width:Number=-1, height:Number=-1, scrollDir:int=-1, beginY:Number=0, func_upSlide:Function=null)
		{
			super();
			...
			if(isFitMode) height = Elever.Main.PageHeightForScroll-Elever.Main.TopMargin-Elever.Main.HeaderHeight;
		...
		{
			if(height < 0) height = Elever.Main.PageHeightForScroll-Elever.Main.TopMargin-Elever.Main.HeaderHeight;
